    ...
    <>
            ...
            {dropdownOpen && (
              <div className="absolute right-0 mt-2 w-56 rounded-xl bg-white border border-neutral-100 shadow-elevated py-1 animate-fadeIn">
                ...
                <button
                  ...
                  className="flex items-center gap-3 w-full px-4 py-2.5 text-sm text-neutral-600 hover:bg-neutral-50 hover:text-neutral-800"
                >
      ...
      {showSignOutConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-2xl shadow-xl border border-neutral-100 w-full max-w-sm mx-4 p-6">
            <div className="flex items-center gap-3 mb-4">
              <div className="flex items-center justify-center w-10 h-10 rounded-full bg-red-50">
                <LogOut className="h-5 w-5 text-red-500" />
              </div>
              <div>
                <h3 className="text-lg font-semibold text-neutral-800">Sign Out</h3>
                <p className="text-sm text-neutral-500">Are you sure you want to sign out?</p>
              </div>
            </div>
            <div className="flex gap-3 mt-6">
              <button
                ...
                disabled={signingOut}
                className="flex-1 px-4 py-2.5 text-sm font-medium text-neutral-600 bg-neutral-100 rounded-xl hover:bg-neutral-200 transition-colors disabled:opacity-50"
              >
                Cancel
              </button>
              <button
